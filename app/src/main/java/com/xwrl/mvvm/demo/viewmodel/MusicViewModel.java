...
public class MusicViewModel extends BaseViewModel{
    ...
    private String mySheets, curSheetName;
    ...
    public String getCurSheetName() {
        return curSheetName == null || TextUtils.isEmpty(curSheetName) ||
                curSheetName.equals(BaseActivity.ACTIVITY_DEFAULT_SHEET_NAME) ? "本地播放" : curSheetName; }
    public void setCurSheetName(String curSheetName) {
        this.curSheetName = curSheetName;
        notifyPropertyChanged(BR.curSheetName);
    }
    @Bindable
    public String getMySheets() { return mySheets == null || TextUtils.isEmpty(mySheets) ?
            mApplication.getString(R.string.label_default_sheets) : mySheets; }

    public void setMySheets(String mySheets) {
        this.mySheets = mySheets;
        notifyPropertyChanged(BR.mySheets);
    }
    ...
    public void SyncMusicInformation(){
        ...
        setPlaybackInfo(StringUtil.SongSingerName(title,artist));
        //时长
