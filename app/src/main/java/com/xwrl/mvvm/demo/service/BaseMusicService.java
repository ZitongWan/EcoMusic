...
public abstract class BaseMusicService extends MediaBrowserServiceCompat {
    ...
    //后台服务Toast通知消息
    public static final String DYQL_CUSTOM_ACTION_TOAST = "toast_dyql";
    public static final String DYQL_CUSTOM_UPDATE_SHEET_LIST = "update_sheet_list_dyql";
    //当前播放歌单与当前页面歌单
    public static final String DYQL_CUSTOM_CURRENT_SHEETNAME = "current_sheet_name_dyql";
    public static final String DYQL_CUSTOM_PLAYING_SHEETNAME = "playing_sheet_name_dyql";
    //更新播放列表
    public static final String DYQL_CUSTOM_ACTION_UPDATE_PLAYLIST = "update_playlist_dyql";
    public static final String DYQL_CUSTOM_ACTION_UPDATE = "update_dyql";
    @Override
